...
public class FaceDetectingActivity extends AppCompatActivity {
        ...
        detector.detectInImage(image)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(FaceDetectingActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void processFaceResult(List<FirebaseVisionFace> firebaseVisionFaces) {
        ...
        Toast.makeText(this, String.format("Detected %d faces in images",count), Toast.LENGTH_SHORT).show();
